    ...
    <div className="about">
      ...
      <div className="text">
        ...
        <p>
          ...
          pensar em soluções/maneiras diferentes de resolver problemas. Já
          trabalhei em projetos de hotsites, blogs, revistas digitais, redes
          sociais, empréstimos, finanças pessoais e projetos white-label.
        </p>
        <p>
